                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="limits.php"    aria-controls="submenu-1"><i class="fa fa-fw fa-user-circle"></i>Limit's <span class="badge badge-success">6</span></a>
                            </li>
                            <li class="nav-item ">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="companyMaster.php" aria-expanded="false"  aria-controls="submenu-1"><i class="fa fa-fw fa-user-circle"></i>Company Details <span class="badge badge-success">6</span></a>
                            </li>
                            <li class="nav-item ">
